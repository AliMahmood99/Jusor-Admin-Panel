...
export const Icons = {
  ...
  thumbsUp: (props: IconProps) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
      <path d="M7 22V11M2 13v6c0 1.1.9 2 2 2h14a2 2 0 0 0 2-1.7l2-6.5a1 1 0 0 0-1-1.3h-4.3a1 1 0 0 1-1-.8l-1-3.5A2 2 0 0 0 13 6h-1.3a2 2 0 0 0-1.7 1L7 11H4a2 2 0 0 0-2 2Z"/>
    </svg>
  ),
